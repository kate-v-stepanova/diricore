...
pc_genes_file = paste(BASE_DIR, "/static/", genome_id, "/coding_genes.txt", sep="")
pc_genes = fread(pc_genes_file, skip = 1, header = F)

print("Creating output directories")
dir.create(plot_dir)
dir.create(data_dir)
# 
# # after running kallisto
...
counts_df[counts_df$transcript %in% pc_genes$V1,] # select coding genes only
rownames(counts_df) <- counts_df$transcript
counts_df$transcript <- NULL
counts_df <- counts_df[pc_genes,]

samples = c("159_clone1_PD",  "159_clone1_SG",  "159_clone2_PD",  "159_clone2_SG",  "159_WT")
samples = c( "231_2D", "231_MM_AUF_NAC", "231_MM_AUF", "231_MM_FK866", "231_MM_NAC", "231_MM")

samples = c("159_clone1_PD",  "159_clone1_SG",  "159_clone2_PD",  "159_clone2_SG",  "159_WT", "231_2D", "231_MM_AUF_NAC", "231_MM_AUF", "231_MM_FK866", "231_MM_NAC", "231_MM")
# samples1 = c("159_GFP", "MRC5_mC", "Mix_GFP", "Mix_mC", "CoC_GFP", "CoC_mC")
# samples2 = c("159_Gminus_GFP", "MRC5_Gminus_mC", "CoC_Gminus_GFP", "CoC_Gminus_mC")
...
# countData1 = countData[,samples2]
countData1 = countData[,samples]
dds <- DESeqDataSetFromMatrix(countData = countData1, colData = colData, design = as.formula(designFormula))
